...
- [Native iOS Client SDK](#native-ios-client-sdk)
...
- [Telnyx Client](#telnyx-client)
  ...
  - [2. Listen to SDK updates](#2-listen-to-sdk-updates)
  - [3 - Connect the client](#3---connect-the-client)
  - [4 - Outbound calls](#4---outbound-calls)
  - [5 - Incoming calls](#5---incoming-calls)
- [Configure CallKit into your App](#configure-callkit-into-your-app)
- [Add Push Notifications capability to your Xcode project](#add-push-notifications-capability-to-your-xcode-project)
- [Custum Headers](#custum-headers)
  - [Passing Custom Headers](#passing-custom-headers)
  - [Accessing Custom Headers](#accessing-custom-headers)
- [Before uploading your app to TestFlight](#before-uploading-your-app-to-testflight)
- [Support](#support)
