...
extension ImageResource {
    ...
    static let icCall = ImageResource(name: "ic-call", bundle: resourceBundle)

    /// The "ic-hangup" asset catalog image resource.
    static let icHangup = ImageResource(name: "ic-hangup", bundle: resourceBundle)

    /// The "logo" asset catalog image resource.
    static let logo = ImageResource(name: "logo", bundle: resourceBundle)

    /// The "logo-white" asset catalog image resource.
    static let logoWhite = ImageResource(name: "logo-white", bundle: resourceBundle)
