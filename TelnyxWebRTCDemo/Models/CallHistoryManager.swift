...
public class CallHistoryManager: ObservableObject {
    ...
    public func trackCallEnd(callId: UUID, status: CallStatus) {
        ...
        database.createCallHistoryEntry(
            callerName: callInfo.callerName ?? "",
            callId: callId,
            callStatus: status.rawValue,
            direction: callInfo.direction.rawValue,
            metadata: "",
            phoneNumber: callInfo.phoneNumber,
            profileId: callInfo.profileId,
            timestamp: Date()) { success in
                print("")
            }
    ...
    public func updateCallStatus(callId: UUID, status: CallStatus) {
        ...
        database.updateCallHistoryEntry(
            ...
            if success {
                ...
                print("CallHistoryManager: Update Failed for call - \(callId) (\(status.rawValue))")
    ...
    public func getCallHistory()  {
        return database.fetchCallHistoryFiltered(by: currentProfileId)
    }
